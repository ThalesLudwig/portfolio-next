export const PT_BR = {
  ...
  "chat.greeting.third": "Nós podemos simular uma entrevista aqui!",
  ...
  "education.greeting.first":
    "Eu sou graduado em Análise de Sistemas pela Faculdade QI.",
  "education.greeting.second":
    "Depois disso comecei duas especializações na UniRitter:",
  ...
  "projects.greeting.second":
    "Eu também tenho um app publicado na Play Store, feito com React Native.",
  ...
  "about.hero":
    "Engenheiro de software, UI/UX Designer. Eu sou uma máquina de aprendizado que converte energéticos em código limpo e escalável.",
  "articles.hero":
  ...
  "contact.social.github":
    "Todos os meus projetos legais estão aqui, dê uma olhada!",
  "contact.social.linkedin":
    "Meu currículo online, com todas aquelas informações básicas.",
  "contact.social.dribbble": "É aqui que eu brinco de ser designer.",
  "contact.social.coffee":
    "Caso você goste muito, muito mesmo do meu trabalho.",
  "contact.social.facebook":
    "Normalmente só para família e amigos, mas ei, vá em frente se quiser.",
  "contact.social.medium":
    "Eu gosto de escrever sobre coisas... Quando tenho tempo.",
  ...
  "projects.name.condofy":
    "O projeto novo no qual estou trabalhando. Está em andamento.",
  "projects.name.swapi":
    "Um projeto para demonstrar o uso do VueJS e suas bibliotecas.",

  "career.job.frontendEngineer": "Engenheiro Front-end",
  "career.job.seniorFullStack": "Engenheiro Full-stack Sênior",
  "career.job.devLead": "Desenvolvedor de Software | Líder Técnico",
  "career.job.developer": "Desenvolvedor de Software",
  "career.job.juniorDeveloper": "Desenvolvedor de Software",
